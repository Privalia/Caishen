...
extension Bundle: CardTypeImageStore {
    ...
    open func image(for cardType: CardType) -> UIImage? {
        return UIImage(named: cardType.name, in: Bundle.resourcesBundle, compatibleWith: nil)
    }
    ...
    open func cvcImage(for cardType: CardType) -> UIImage? {
        ...
        return UIImage(named: cvcImageName, in: Bundle.resourcesBundle, compatibleWith: nil)
    }
